...
- I built this app using React combined with MaterialUI.
- Focused on Functional React components over Class based Components.
- Utilized React hooks when approapriate.

## Why I built the project this way
- I didn't use a state management library like Redux on purpose. For this app `Context api ` & `useState` was suffient for State mnageement.
- Material UI is an effient tool in building out responsive complex interfaces in a short amount of time.
- Material UI simplifies the creation of respionsive, consistant, and customizable user interfaces.

## Future areas for improvement
- Refactor components into smaller more encapsulated react components.
